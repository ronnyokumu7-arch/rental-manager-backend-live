...
def get_agency_health(
    ...
    try:
        ...
        avg_session = db.query(func.avg(User.avg_session_duration_minutes)).filter(
        ...
        # 3. Revenue Velocity (Counts Only)
        ...
        # 5. Composite Health Score (Weighted Algorithm)
        score = 0
        ...
        return {
            ...
            "activity": {
                ...
                "lastActiveAt": None,
                "avgSessionDurationMinutes": round(avg_session, 1)
            },
            "utilization": {
