...
from app.db.database import get_db # Ensure this is imported
from app.dependencies.rbac import require_role # ✅ FIXED: Import from rbac
...
def get_agency_health(
    ...
    # ✅ FIXED: Use require_role instead of the non-existent get_current_super_admin
    ...
    try:
        ...
        # ✅ FIXED: Removed query for non-existent 'avg_session_duration_minutes' column
        avg_session = 0 
        ...
        score += min((login_counts.logins_7d / 7) * 2, 20) 
